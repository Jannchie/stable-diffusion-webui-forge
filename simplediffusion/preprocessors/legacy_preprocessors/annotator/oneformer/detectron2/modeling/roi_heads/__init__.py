...
from .keypoint_head import (ROI_KEYPOINT_HEAD_REGISTRY, BaseKeypointRCNNHead,
...
from .roi_heads import (ROI_HEADS_REGISTRY, Res5ROIHeads, ROIHeads,
                        StandardROIHeads, build_roi_heads,
