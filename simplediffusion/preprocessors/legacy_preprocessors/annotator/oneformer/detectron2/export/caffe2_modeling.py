...
from annotator.oneformer.detectron2.structures import (Boxes, ImageList,
                                                       Instances, RotatedBoxes)

from .c10 import Caffe2Compatible
from .caffe2_patch import ROIHeadsPatcher, patch_generalized_rcnn
from .shared import (alias, check_set_pb_arg, get_pb_arg_floats,
                     get_pb_arg_valf, get_pb_arg_vali, get_pb_arg_vals,
