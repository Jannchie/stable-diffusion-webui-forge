...
from annotator.oneformer.detectron2.modeling import (META_ARCH_REGISTRY,
                                                     build_backbone,
                                                     build_sem_seg_head)
from annotator.oneformer.detectron2.modeling.backbone import Backbone
from annotator.oneformer.detectron2.modeling.postprocessing import \
    sem_seg_postprocess
from annotator.oneformer.detectron2.structures import (BitMasks, Boxes,
                                                       ImageList, Instances)
from annotator.oneformer.detectron2.utils.memory import retry_if_cuda_oom
from annotator.oneformer.oneformer.data.tokenizer import (SimpleTokenizer,
                                                          Tokenize)
