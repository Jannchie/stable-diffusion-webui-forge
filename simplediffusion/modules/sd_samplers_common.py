...
def samples_to_images_tensor(sample, approximation=None, model=None):
    ...
    if approximation is None or (interrupted and live_preview_fast_interrupt):
...
def images_tensor_to_samples(image, approximation=None, model=None):
    ...
    if approximation == 3:
        ...
        return (
            ...
            if len(image) > 1
            else model.get_first_stage_encoding(model.encode_first_stage(image))
        )
    ...
    def launch_sampling(self, steps, func):
        ...
        try:
            ...
            print(
                ...
                "You should try to use a smaller rho value instead."  # type: ignore
            )
