...
class ControlNetPatcher(ControlModelPatcher):
    ...
    def try_build_from_state_dict(controlnet_data, ckpt_path):
        ...
        if (
            ...
            controlnet_config = unet_config_from_diffusers_unet(
        ...
        if controlnet_config is None:
            unet_dtype = memory_management.unet_dtype()
            controlnet_config = model_config_from_unet(
        ...
        with using_forge_operations(
            dtype=unet_dtype, manual_cast_enabled=computation_dtype != unet_dtype
        ):
        ...
        if pth:
            if "difference" in controlnet_data:
                print(
                    ...
                    "Please use an official float16/float32 model for robust performance."  # type: ignore
                )
        ...
        control = ControlNet(
            ...
            manual_cast_dtype=computation_dtype,
        )
